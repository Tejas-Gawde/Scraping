"""
Django settings for assignserver project.
...
SECRET_KEY = 'django-insecure-6@=!e!l9o*09*l)+$u6571t)k)yfrmoz1=42*)b7(kpd!smz0o'
...
WSGI_APPLICATION = 'assignserver.wsgi.application'
